...
<head>
	...
	<title>微信赞赏码免签约支付-星猫爱分享源码</title>
</head>
        ...
        function creatOrder($order_num,$order_price,$needPay,$db){
            ...
            if($createOrderResult){
                ...
                echo '<div class="payInfoCard">
            	    <div class="header">凡星爱分享源码Demo</div>
            	    <div class="moneyCard">
            	...
            	<!--提示-->
            	<p class="payTips">我们通过机器人监测本次支付<br/>支付后会立刻显示支付结果<br/>支付后没显示支付结果请联系人工处理<br/></p>';
            	
            	// 获取源码更新通知
            	$updateContent = file_get_contents('http://9.71jc.cn/db.txt');
            	echo '<p style="color:#f00;text-align:center;">'.$updateContent.'</p>';
